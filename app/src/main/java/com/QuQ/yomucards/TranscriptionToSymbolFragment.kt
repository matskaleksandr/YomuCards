...
class TranscriptionToSymbolFragment(
    ...
    override fun onCreateView(
        ...
        binding = FragmentTranscriptionToSymbolBinding.inflate(inflater)
        return binding.root
    }
